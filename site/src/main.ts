...
<main id="main">
  ...
  <section class="privacy">
    <div class="privacy-symbol" aria-hidden="true"><img src="./logo.svg" alt="" />${star}</div><p class="eyebrow">DEIN JOURNAL GEHÖRT DIR</p><h2>Dein Kopf ist schon voll. <br><em>Deine App muss es nicht sein.</em></h2><p>Kein Konto nötig. Kein Feed. Kein Vergleich. <br>Deine Einträge bleiben auf deinem iPhone. <br>Auch dann, wenn du gerade offline bist.</p><div class="privacy-notes"><span>Auf deinem Gerät</span><span>Manuelles Backup</span><span>PDF zum Mitnehmen</span></div>
  </section>
  ...
  <section class="outro"><span aria-hidden="true">${star}</span><p class="eyebrow">DER NÄCHSTE AHA-MOMENT KOMMT BESTIMMT.</p><h2>Gib ihm <br><em>eine Lernspur.</em></h2>${getApp}<p>Fürs iPhone. Bald im App Store. <br><a href="./release.html">Bis dahin: Version 1.0 entdecken ↗</a></p></section>
</main>
<footer><a class="brand" href="#"><img src="./logo.svg" alt="" width="30" height="30" /><span>lernspur</span></a><span>Für deinen Lernweg. In deinem Tempo.</span><div><a href="./native.html">App-Einblicke</a><a href="./privacy.html">Datenschutz</a><a href="./support.html">Hilfe</a><a href="https://github.com/platret/lernspur-preview">GitHub ${arrow}</a></div></footer>`;
